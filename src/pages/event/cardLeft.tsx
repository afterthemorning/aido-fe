...
export default function CardLeft(props: Props) {
  ...
  return (
    <div className='aido-biz-group-container' style={{ width: 240, marginRight: 10 }}>
      ...
      <Modal title={editForm ? t('common:btn.edit') : t('common:btn.add')} open={visible} onOk={handleOk} onCancel={handleCancel} destroyOnHidden>
        <Form
          form={form}
          layout='vertical'
          preserve={false}
